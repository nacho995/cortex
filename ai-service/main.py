...
CREATE_SYSTEM = (
    ...
    "- If the user says MERN, you generate MongoDB + Express + React + Node.js. NOT Java. NOT Spring Boot. "
    ...
    "- Include proper CSS with modern design (flexbox, grid, animations, gradients). "
