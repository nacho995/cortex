...
TASK_ROUTING = {
    ...
    "create_simple": {"provider": "google", "model": "gemini-2.5-pro"},
    "create_complex": {"provider": "google", "model": "gemini-2.5-pro"},
    "add": {"provider": "google", "model": "gemini-2.5-pro"},
    "generate": {"provider": "google", "model": "gemini-2.5-pro"},
